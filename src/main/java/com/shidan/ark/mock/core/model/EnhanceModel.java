...
import com.shidan.ark.mock.core.plugins.domain.Behavior;
...
public class EnhanceModel {
    ...
    EnhanceModel(String classPattern, EnhanceModel.MethodPattern[] methodPatterns, Event.Type[] watchTypes, boolean includeSubClasses) {
